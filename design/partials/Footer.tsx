        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-300">
                <li><Link to="/" className="hover:text-white transition hover:translate-x-1 duration-200 inline-block">{t('nav_home')}</Link></li>
                <li><Link to="/villas" className="hover:text-white transition hover:translate-x-1 duration-200 inline-block">{t('nav_villas')}</Link></li>
                <li><Link to="/reviews" className="hover:text-white transition hover:translate-x-1 duration-200 inline-block">{t('nav_reviews')}</Link></li>
                <li><Link to="/portal" className="hover:text-white transition hover:translate-x-1 duration-200 inline-block">{t('login_client')}</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs text-amber-600 mb-6">{t('nav_contact')}</h4>
              <ul className="space-y-3 text-sm text-slate-300">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link to="/faq" className="cursor-pointer hover:text-white transition">FAQ</Link>
            </div>
          </div>
        </div>
      </footer>
