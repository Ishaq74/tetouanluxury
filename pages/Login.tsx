...
export const LoginPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex bg-stone-50 animate-fade-in">
            <SEO title={t('login_title')} description={t('login_subtitle')} />
            ...
            <div className="hidden lg:block w-1/2 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-slate-900/40 flex flex-col justify-end p-16 text-white">
                    <h2 className="font-serif text-4xl mb-4">{t('login_welcome')}</h2>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="font-serif text-3xl text-slate-900 mb-2">{t('login_title')}</h1>
                        ...
                        <div className="p-8">
                            <form onSubmit={handleLogin} className="space-y-6">
                                {activeTab === 'CLIENT' ? (
                                    <>
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-slate-500 mb-2">{t('login_label_email')}</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-slate-500 mb-2">{t('login_label_ref')}</label>
                                            <div className="relative">
                                    ...
                                    <>
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold uppercase text-slate-500 mb-2">{t('login_label_password')}</label>
                                            <div className="relative">
                                ...
                                >
                                    {loading ? '...' : t('login_btn')} <ArrowRight size={18} className="ml-2" />
                                </button>
                            </form>
